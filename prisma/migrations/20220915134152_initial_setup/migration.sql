-- CreateTable
CREATE TABLE "Operafy" (
    "id" SERIAL NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "Operafy_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_operafyId_fkey" FOREIGN KEY ("operafyId") REFERENCES "Operafy"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Album" ADD CONSTRAINT "Album_operafyId_fkey" FOREIGN KEY ("operafyId") REFERENCES "Operafy"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
